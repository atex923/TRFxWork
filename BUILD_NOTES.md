...
```bat
python -m nuitka --onefile --enable-plugin=tk-inter --windows-console-mode=disable --windows-icon-from-ico=assets\icon_result.ico --output-dir=outputs\TRFxWork_V0_1_6_onefile --output-filename=TRFxWork_V0_1_6.exe TR_FxWork_V0_1_6.py
```
